...
UPDATE Inscricao SET Valor = '100.00'
WHERE ID_Palestra = 21

UPDATE Inscricao SET Valor = '80.00'
WHERE ID_Palestra = 54
 ...
 ADD CONSTRAINT Fk_Palestrante_Ingresso
 ...
 EXEC sp_rename 'Inscricao', 'Ingresso'
  ...
  DELETE ID_incricao, ID_Palestra, ID_Participante, Valor
  WHERE ID_inscricao = 745
