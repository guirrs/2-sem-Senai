...
using Sistema_de_Personagens_Jogo.Data;
using Sistema_de_Personagens_Jogo.Models;

namespace Sistema_de_Personagens_Jogo.Controllers
{
    public class PersonagemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Nivel,Classe")] TabelaPersonagem tabelaPersonagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Nivel,Classe")] TabelaPersonagem tabelaPersonagem)
        {
